        ...
        <div className="analysis-header">
          <div className="analysis-nav">
            ...
            <div className="analysis-nav-links">
              ...
              <a className="active">Test Analysis</a>
        ...
        <div className="analysis-container">
          ...
          <div style={{ marginBottom: 8 }}>
            ...
            <p style={{ fontSize: 13, color: '#aaa', marginTop: 4 }}>
              Completed on {attempt?.completed_at ? new Date(attempt.completed_at).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' }) : 'N/A'}
            </p>
          </div>
          ...
          {/* ── MISTAKE ANALYSIS + AI STUDY ────────────── */}
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: 20, margin: '28px 0' }}>
                    ...
                    <div key={q.id} className="q-card">
                      <div className="q-header" onClick={() => setExpandedQ(isExpanded ? null : idx)}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                          <span style={{ fontSize: 12, color: '#aaa' }}>
                            {isSkipped ? 'Skipped' : `Time taken: ${formatTime(ans.time_taken_seconds || 0)}`}
                          </span>
                          {isSkipped
                      ...
                      {isExpanded && (
                        <div className="q-body" style={{ paddingTop: 16 }}>
                          <p style={{ fontSize: 14, fontWeight: 600, color: '#333', lineHeight: 1.6, marginBottom: 12 }}>
                            {q.question_text}
                          </p>
              ...
              {!studyPlan ? (
                 ...
                 <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                   ...
                   <div style={{ display: 'flex', gap: 12, marginTop: 12, justifyContent: 'flex-end' }}>
                     <button onClick={handleGeneratePlan} style={{ padding: '12px 20px', background: '#fff', border: '1px solid #e5e7eb', color: '#6b7280', fontSize: 13, fontWeight: 700, borderRadius: 10, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}>
                       {generatingPlan ? <Spinner size={16} className="animate-spin" /> : <ArrowClockwise size={16} />} Regenerate Plan
                     </button>
          ...
          <div style={{ display: 'flex', gap: 12, margin: '32px 0', justifyContent: 'center' }}>
            <button className="btn-primary" onClick={() => router.push('/tests')}>
